...
- Inline new icons as JSX with `stroke="currentColor"` and
  `aria-hidden="true"` so they inherit text color and stay out of the
  accessibility tree. Do not add an icon package for a handful of marks.
